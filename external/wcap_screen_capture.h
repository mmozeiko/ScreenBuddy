...
typedef void ScreenCapture_OnFrameCallback(ScreenCapture* Capture, bool Closed);
...
// from ntdll.dll
EXTERN_C DECLSPEC_IMPORT LONG WINAPI RtlGetVersion(RTL_OSVERSIONINFOW*);

// from CoreMessaging.dll
EXTERN_C DECLSPEC_IMPORT HRESULT WINAPI CreateDispatcherQueueController(DispatcherQueueOptions, IInspectable**);

// from d3d11.dll
EXTERN_C DECLSPEC_IMPORT HRESULT WINAPI CreateDirect3D11DeviceFromDXGIDevice(IDXGIDevice*, IInspectable**);
...
static HRESULT STDMETHODCALLTYPE ScreenCapture__FrameQueryInterface(__FITypedEventHandler_2_Windows__CGraphics__CCapture__CDirect3D11CaptureFramePool_IInspectable* This, REFIID Riid, void** Object)
{
	...
	if (IsEqualGUID(Riid, &IID_IDirect3D11CaptureFramePoolHandler) || IsEqualGUID(Riid, &IID_IAgileObject) || IsEqualGUID(Riid, &IID_IUnknown))
	{
		*Object = This;
		return S_OK;
	}
...
static HRESULT STDMETHODCALLTYPE ScreenCapture__CloseQueryInterface(__FITypedEventHandler_2_Windows__CGraphics__CCapture__CGraphicsCaptureItem_IInspectable* This, REFIID Riid, void** Object)
{
	...
	if (IsEqualGUID(Riid, &IID_IGraphicsCaptureItemHandler) || IsEqualGUID(Riid, &IID_IAgileObject) || IsEqualGUID(Riid, &IID_IUnknown))
	{
		*Object = This;
		return S_OK;
	}
